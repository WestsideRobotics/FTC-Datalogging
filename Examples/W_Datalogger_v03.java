/*
 ...
 This v03 adds another default column: the time (in milliseconds) *between*
 ...
 To improve exception handling, v02 also added method finalize() which calls
 existing method closeDataLogger().
...
public class W_Datalogger_v03 {
    ...
    public W_Datalogger_v03 (String fileName) {
        ...
        addField("d ms");               // second/default column heading
    }   // end constructor
    ...
    private void flushLineBuffer(){
        ...
        // Update and log first two columns (cumulative and incremental time).
        ...
        // Divide nanoseconds by 1,000,000 to log milliseconds.
        // For Java type "long", use scientific notation for 1,000,000.
        addField(String.format("%.3f",(nanoTime - nsBase) / 1.0E6));
        nsBase      = nanoTime;         // reset for incremental time delta
    }

    // The OpMode calls this *public* method to complete the current line (row)
    // of data and prepare for another.
    public void newLine() {
        flushLineBuffer();
    }
    ...
    // This method improves exception handling.
    @Override
